...
<body>
    ...
    <!-- <body onload="botmanChatWidget.open();"> -->
        ...
        <div id="cuerpo" class="container-fluid">
            ...
            <script type="application/javascript">
                var botmanWidget = {
                    ...
                    bubbleAvatarUrl: '/images/robot5.png'  
                };
            </script>
...
<!-- <script type="application/javascript">botmanChatWidget.open()</script> -->
<!-- <script type="application/javascript">alert("hola")</script> -->
<!-- <a href="#" class="btn" onload="botmanChatWidget.open();return false;">-</a> -->
