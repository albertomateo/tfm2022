<template>
    <div id="cuerpo" class="container-fluid">
        <h3 class="text-center"><a href="/vistaTopics">TEMAS DE CATASTRO</a></h3>
        ...
        <table class="table table-hover table table-bordered"> -->
            ...
            <td v-if="user_id">
                <input v-if="user_id" type="text" id="documento_nuevo" />
                <input
                    v-if="user_id"
                    class="form-control"
                    type="file"
            ...
            <tbody v-else>
                ...
                <div id="matriz" class="row">
                    <div
                        ...
                        :key="topic.id"
                        class="card col-md-3 themed-grid-col"
                    >
 ...
 */
        ...
        async listartodos() {
            ...
            const respuesta = await axios.get("/topics/filtrar/" + "CATASTRO", {});
        ...
        async filtrarportexto() {
            ...
            // const respuesta =  axios.get("/topics/filtrar/"+'ww', {
